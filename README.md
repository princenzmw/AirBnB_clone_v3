...
- Clone this repository: `git clone "https://github.com/princenzmw/AirBnB_clone_v3.git"`
...
- `<class name>.all()` - Prints all string representation of all instances of a class
- `<class name>.count()` - Prints the number of instances of a class
...
- `def test_is_base_odel(self)` - Test that the instatiation of a BaseModel works
...
Prince NZAMUWE - [Github](https://github.com/princenzmw) / [Twitter](https://twitter.com/princenzmw)

## License

MIT - No copyright protection.
